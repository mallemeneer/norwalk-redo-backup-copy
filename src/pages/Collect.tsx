...
const Collect: React.FC = () => {
  ...
  const toggleCasting = () => {
    if (castingModeLabelRef.current?.textContent == "Casting") {
      setStateCastingModeLabel("Not casting");
      setShowLoading(false);
      setShowLoading(true);
    } else if (castingModeLabelRef.current?.textContent == "Not casting") {
      setShowLoading(false);
      setShowLoading(true);
      setStateCastingModeLabel("Casting");
    } else if (norwalkModeLabelRef) {
      setStateCastingModeLabel("Casting");
    }
  };
  ...
  return (
    <IonPage>
      ...
      <IonContent fullscreen className="nw-background" onLoad={initNorwalk}>
        <IonLabel className="ion-hide" ref={castingModeLabelRef}>{stateCastingModeLabel}</IonLabel>
        <IonAlert
          translucent
              ...
              <IonFab vertical="center" horizontal="center">
                ...
                <IonFabList side="end" className="custom-fab-list-right">
                  <IonFabButton
                    ...
                    translucent
                  >
                    {castingModeLabelRef.current?.textContent ==
                    "Casting" ? (
                      <React.Fragment>
                        <FontAwesomeIcon
                    icon={faChromecast}
